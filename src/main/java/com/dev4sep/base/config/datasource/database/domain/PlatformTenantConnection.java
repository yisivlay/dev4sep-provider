...
@AllArgsConstructor
@Jacksonized
public class PlatformTenantConnection implements Serializable {
    ...
    public PlatformTenantConnection(final Long connectionId, final String schemaName, String schemaServer,
    ...
    public String toString() {
        var sb = new StringBuilder(this.schemaName)
                .append(":")
                .append(this.schemaServer)
                .append(":")
