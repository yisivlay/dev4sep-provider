            ...
            try (var rs = selectStatement.executeQuery(
                ...
                while (rs.next()) {
                    ...
                    if (!Boolean.TRUE.equals(done.get(id))) {
                        var readOnlySchemaPassword = rs.getString("readonly_schema_password");
                        var encryptedPassword = databasePasswordEncryptor.encrypt(readOnlySchemaPassword);
                        ...
                        var updateSql = String.format(
                                ...
                                encryptedPassword, databasePasswordEncryptor.getMasterPasswordHash(),
                                id);
