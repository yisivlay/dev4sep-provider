...
import com.dev4sep.base.adminstration.permission.service.PermissionWritePlatformService;
...
@CommandType(entity = PermissionApiConstants.PERMISSIONS, action = "UPDATE")
public class UpdatePermissionCommandHandler implements CommandSourceHandler {
