...
@CommandType(entity = RoleApiConstants.PERMISSIONS, action = "DISABLE")
public class DisableRoleCommandHandler implements CommandSourceHandler {
    ...
    public CommandProcessing processCommand(final JsonCommand command) {
        return this.writePlatformService.disableRole(command.getResourceId());
    }
}
