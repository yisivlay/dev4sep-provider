...
@CommandType(entity = RoleApiConstants.PERMISSIONS, action = "ENABLE")
public class EnableRoleCommandHandler implements CommandSourceHandler {
    ...
    public CommandProcessing processCommand(final JsonCommand command) {
        return this.writePlatformService.enableRole(command.getResourceId());
    }
}
